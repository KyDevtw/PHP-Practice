 ...
 */
$total =  $pdo->query("SELECT COUNT(itemId) AS `count` FROM `items`")->fetchAll()[0]['count'];
...
$totalCatogories = $pdo->query("SELECT COUNT(categoryId) AS `count` FROM `categories`")->fetchAll()[0]['count'];
?>
